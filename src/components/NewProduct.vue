    ...
    <div class="row">
      <div class="card offset-2 col-md-3">
        <div class="card-body tex-center d-flex align-items-center flex-column">
          ...
          <input ref="file" type="file" style="display: none;" @change="onChange($event)" class="form-control" required>
        ...
        <div class="col-md-11 card">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="adını giriniz" v-model="product.title" required>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label>Ürün Adeti</label>
                <input type="text" class="form-control" placeholder="adetini giriniz" v-model="product.count" required>
              </div>
              <div class="form-group col-md-6">
                <label>Ürün Fiyatı</label>
                <input type="text" class="form-control" placeholder="fiyatını giriniz" v-model="product.price" required>
              </div>
            </div>
...
<script>
    ...
    export default {
        ...
        addProduct(){
            this.canshow = true
            this.product.netprice = this.product.count * this.product.price;
